...
class FeedService{
  ...
  void postMessage(String body, String identity, String encodedSk) async {
  ...
  void _storeMessage(FeedMessage message) async {
    Database database = await _createOrOpenDatabase();
  ...
  Future<List<FeedMessage>> retrieveMessages({ required String identity, int hops = 2 } /* We may have more parameters here in future */) async {
